  ...
  template: `
    <div class="pt-12">
      ...
      <div class="mt-8 flex flex-wrap gap-8 justify-center">
        <ng-container *ngIf="!loading.articles; else skeletonArticles">
      ...
      <div class="mt-8 flex flex-wrap gap-8 justify-center">
        <ng-container *ngIf="!loading.symbolArticles; else skeletonSymbols">
      ...
      <h2 class="text-3xl font-black mt-16 mb-10 text-center text-pink-700 tracking-tight drop-shadow">Positive Sentiment News</h2>
      <div class="mt-8 flex flex-wrap gap-8 justify-center">
        <ng-container *ngIf="!loading.positiveArticles; else skeletonPositive">
          <div *ngFor="let article of positiveArticles"
               class="bg-white rounded-2xl shadow-lg w-80 flex flex-col overflow-hidden hover:scale-105 hover:shadow-2xl transition-all duration-300 border border-gray-100">
            <img *ngIf="article.image_url"
                 [src]="article.image_url"
                 alt="Article cover"
            ...
            <div class="p-5 flex flex-col flex-1">
              ...
              <a [href]="article.url"
                 target="_blank"
                 rel="noopener"
                 class="mt-auto inline-block px-4 py-2 bg-pink-600 text-white rounded-lg shadow hover:bg-pink-700 transition-colors text-center font-medium">
                Read more
              </a>
            </div>
          </div>
        </ng-container>
        <ng-template #skeletonPositive>
          <div *ngFor="let n of skeletonArray" class="bg-gray-100 animate-pulse rounded-2xl shadow-lg w-80 flex flex-col overflow-hidden border border-gray-100">
            <div class="h-48 w-full bg-gray-200"></div>
            <div class="p-5 flex flex-col flex-1">
              <div class="h-6 bg-gray-200 rounded mb-2 w-3/4"></div>
      ...
      <h2 class="text-3xl font-black mt-16 mb-10 text-center text-red-700 tracking-tight drop-shadow">Negative Sentiment News</h2>
      <div class="mt-8 flex flex-wrap gap-8 justify-center">
        <ng-container *ngIf="!loading.negativeArticles; else skeletonNegative">
          <div *ngFor="let article of negativeArticles"
               class="bg-white rounded-2xl shadow-lg w-80 flex flex-col overflow-hidden hover:scale-105 hover:shadow-2xl transition-all duration-300 border border-gray-100">
            <img *ngIf="article.image_url"
                 [src]="article.image_url"
                 alt="Article cover"
            ...
            <div class="p-5 flex flex-col flex-1">
              ...
              <a [href]="article.url"
                 target="_blank"
                 rel="noopener"
                 class="mt-auto inline-block px-4 py-2 bg-red-600 text-white rounded-lg shadow hover:bg-red-700 transition-colors text-center font-medium">
                Read more
              </a>
            </div>
          </div>
        </ng-container>
        <ng-template #skeletonNegative>
          <div *ngFor="let n of skeletonArray" class="bg-gray-100 animate-pulse rounded-2xl shadow-lg w-80 flex flex-col overflow-hidden border border-gray-100">
            <div class="h-48 w-full bg-gray-200"></div>
            <div class="p-5 flex flex-col flex-1">
              <div class="h-6 bg-gray-200 rounded mb-2 w-3/4"></div>
